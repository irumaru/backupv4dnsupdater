...
import time
import log
from config import HTTP_CHECK_HOST_NAME, HTTP_CHECK_HOST_PORT, HTTP_CHECK_HOST_URI, HTTP_CHECK_HOST_TIMEOUT, HTTP_CHECK_HOST_RETRY, HTTP_CHECK_HOST_HTTPS_PORT, HTTP_CHECK_HOST_HTTPS_URI
